...
void LCD_sendnibble(unsigned char number)
{
    ...
    if (number & 0b000000001) LATBbits.LATB3 = 1; else LATBbits.LATB3 = 0;
    if (number & 0b000000010) LATBbits.LATB2 = 1; else LATBbits.LATB2 = 0;
    if (number & 0b000000100) LATEbits.LATE3 = 1; else LATEbits.LATE3 = 0;
    if (number & 0b000001000) LATEbits.LATE1 = 1; else LATEbits.LATE1 = 0;
    LCD_E_TOG();
