...
void Callibrate(void) {
    if (LATDbits.LATD7)
    {
        if (hour < 12) {sunrisetime = hour*60 + minute;}
        if (hour > 12) {sunsettime = hour*60 + minute;

            eot = 9.87 * sinf(2 * ((360 * (day - 81) / 365.0) * 3.14159265358979323846 / 180)) -
            7.67 * sinf((360 * (day - 81) / 365.0 + 78.7) * 3.14159265358979323846 / 180);
